...
"border: none;"));
    ...
    {
        BaxterIO->setWindowTitle(QApplication::translate("BaxterIO", "BaxterIO", 0));
#ifndef QT_NO_WHATSTHIS
        BaxterIO->setWhatsThis(QApplication::translate("BaxterIO", "<html><head/><body><p>jghjhkhk</p></body></html>", 0));
