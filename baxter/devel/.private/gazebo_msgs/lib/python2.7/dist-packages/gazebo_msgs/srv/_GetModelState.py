...
class GetModelStateResponse(genpy.Message):
  _md5sum = "ccd51739bb00f0141629e87b792e92b9"
...
float64 y
float64 z"""
  __slots__ = ['header','pose','twist','success','status_message']
  _slot_types = ['std_msgs/Header','geometry_msgs/Pose','geometry_msgs/Twist','bool','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,pose,twist,success,status_message
...
class GetModelState(object):
  ...
  _md5sum = '4c515e936d3319c9610c559c60bfc3d4'
