...
class SoundRequestActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new SoundRequestFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SoundRequestFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SoundRequestActionFeedback(null);
    ...
    data.feedback = SoundRequestFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SoundRequestActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = SoundRequestFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new SoundRequestFeedback()
    }
...
module.exports = SoundRequestActionFeedback;
